...
var arr = [1,2,3,4,5];
var tmp = [];
// 1. length 함수: 배열길이 아렬줌
console.log('length: ' + arr.length);

// 2. shift 함수
arr.unshift(0); // 오른쪽으로 밀기(첫번째가 0이됨)
...
for(var idx in arr){
    console.log(arr[idx]);
}// 배열이 비어있는경우에는 건너뛴다, ㅏ인덱스를 뽑아서 쓰는 방법
